...
__decorate([
    (0, common_1.Get)(''),
    (0, role_decorator_1.HasRoles)(role_guard_1.Roles.USER),
...
__decorate([
    (0, swagger_1.ApiOperation)({ description: 'get all available account(for admin only)' }),
    (0, common_1.Get)('index'),
    (0, role_decorator_1.HasRoles)(role_guard_1.Roles.ADMIN),
    openapi.ApiResponse({ status: 200 }),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", void 0)
], AccountController.prototype, "findOneForAdmin", null);
__decorate([
    (0, common_1.Patch)(''),
    openapi.ApiResponse({ status: 200 }),
    __param(0, (0, user_decorator_1.User)('id')),
